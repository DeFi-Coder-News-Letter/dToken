...
The actual code on the mainnet is at here:
    https://etherscan.io/address/0xeb269732ab75a6fd61ea60b06fe994cd32a83549#code
========================================================================
*/
...
//     {
//         if (src != msg.sender) {
//             require(_allowed[src][msg.sender] >= wad, "ds-token-insufficient-approval");
//             _allowed[src][msg.sender] = sub(_allowed[src][msg.sender], wad);
//         }
...
contract usdxFaucet is ERC20, DSStop {
    ...
    function approve(address guy, uint wad) public stoppable returns (bool) {
        require(_allowed[msg.sender][guy] == 0 || wad == 0); //take care of re-approve.
    ...
    function transferFrom(address src, address dst, uint wad)
        ...
        returns (bool)
    {
        if (src != msg.sender && _allowed[src][msg.sender] != uint(-1)) {
            require(_allowed[src][msg.sender] >= wad, "ds-token-insufficient-approval");
            _allowed[src][msg.sender] = sub(_allowed[src][msg.sender], wad);
        }
    ...
    function _burn(address guy, uint wad) internal {
        ...
        if (guy != msg.sender && _allowed[guy][msg.sender] != uint(-1)) {
            require(_allowed[guy][msg.sender] >= wad, "ds-token-insufficient-approval");
            _allowed[guy][msg.sender] = sub(_allowed[guy][msg.sender], wad);
        }
